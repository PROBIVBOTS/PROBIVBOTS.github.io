...
[CyberSecBot](/OpenDataBot/) — тоже бесплатный OSINT бот, парсит данные только по открытым источникам и весьма не плохо. Инфу собирает о номерах телефонах, ID телеги, ищет сообщения пользователя Телеграмм, Вк профиле и много другой инфы.
